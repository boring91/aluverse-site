...
export const testimonials = [
	{
		quote:
			'Aluverse transformed our home with stunning bi-fold doors. The quality of workmanship is exceptional, and the team was professional from start to finish.',
		author: 'James & Sarah Mitchell',
		location: 'Bondi, Sydney',
	},
	{
		quote:
			'We had all the windows replaced in our commercial office. The double glazing has made an incredible difference to noise and temperature.',
		author: 'David Chen',
		location: 'Parramatta, Sydney',
	},
	{
		quote:
			'Fantastic experience from quote to completion. The security screens look amazing and we feel so much safer. Above and beyond.',
...
export const products: Product[] = [
	{
		...
		cardImage: 'https://images.unsplash.com/photo-1701422054542-4a160a0c459c?w=800&q=80',
		heroImage: 'https://images.unsplash.com/photo-1701422054542-4a160a0c459c?w=1920&q=80',
	...
	},
	{
		...
		cardImage: 'https://images.unsplash.com/photo-1604014237800-1c9102c219da?w=800&q=80',
		heroImage: 'https://images.unsplash.com/photo-1604014237800-1c9102c219da?w=1920&q=80',
		...
		related: ['casement-windows', 'sliding-windows', 'double-glazing-windows'],
	},
	{
		...
		cardImage: 'https://images.unsplash.com/photo-1495524455245-b0f961d738a9?w=800&q=80',
		heroImage: 'https://images.unsplash.com/photo-1495524455245-b0f961d738a9?w=1920&q=80',
	...
	},
	{
		...
		cardImage: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=800&q=80',
	...
	},
	{
		...
		cardImage: 'https://images.unsplash.com/photo-1526842748204-cd64a90225bb?w=800&q=80',
		heroImage: 'https://images.unsplash.com/photo-1526842748204-cd64a90225bb?w=1920&q=80',
		...
		related: ['sliding-windows', 'casement-windows', 'double-glazing-windows'],
	},
	{
		slug: 'sliding-doors',
		category: 'doors',
		...
		cardImage: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=800&q=80',
	...
	},
	{
		...
		cardImage: 'https://images.unsplash.com/photo-1610369525649-fe1c49d0f1e6?w=800&q=80',
		heroImage: 'https://images.unsplash.com/photo-1610369525649-fe1c49d0f1e6?w=1920&q=80',
	...
	},
	{
		...
		cardImage: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&q=80',
...
export const windowProducts = products.filter((product) => product.category === 'windows');
export const doorProducts = products.filter((product) => product.category === 'doors');
